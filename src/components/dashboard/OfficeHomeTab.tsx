...
export const OfficeHomeTab: React.FC<OfficeHomeTabProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-12 auto-rows-auto xl:auto-rows-[160px] gap-4 flex-1 min-h-0">
      ...
      <div className="xl:col-span-5 xl:row-span-2 flex flex-col min-h-[340px] xl:min-h-0">
      ...
      <div className="xl:col-span-7 xl:row-span-2 flex flex-col min-h-[400px] xl:min-h-0">
        <LastMatchReport layoutMode="widget" />
      </div>

      {/* Bottom Left: League Table Summary (4 Cols, 2 Rows) */}
      <div className="xl:col-span-4 xl:row-span-2 flex flex-col min-h-[300px] xl:min-h-0">
        <LeagueTable 
          standings={standings} 
          teams={teams}
      ...
      <div className="xl:col-span-4 xl:row-span-2 flex flex-col min-h-[300px] xl:min-h-0 z-10 relative">
